...
from server.routes import datasets, agent, features, deployment, governance, quote_stream, genie, development, review, compare, factory, factory_real, pricing, admin, supervisor, live_pricing, mcp, broker, distribution, optimisation, overview, optimisation_demo
import os
...
app.include_router(optimisation_demo.router)
