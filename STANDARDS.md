...
- **Reviewed against standard version:** `2.1`
...
- **Last panel review:** 2026-08-26 — v2.1 **seven-agent** panel on the Optimiser module (see `docs/REVIEW/REVIEW_REPORT_optimiser_v2.1.md`); Legacy at v2.0.
